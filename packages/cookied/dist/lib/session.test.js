...
describe("SessionCookie.parse", () => {
    it("parses valid cookies", () => {
        assert.deepEqual(SessionCookie.parse("1 AAAAAAAAAAAAAAAAAAAAAA"), new SessionCookie(1, Buffer.from("00000000000000000000000000000000", "hex")));
        assert.deepEqual(SessionCookie.parse("1 /+AAAAAAAAAAAAAAAAAAAA"), new SessionCookie(1, Buffer.from("ffe00000000000000000000000000000", "hex")));
        assert.deepEqual(SessionCookie.parse("9007199254740991 /+AAAAAAAAAAAAAAAAAAAA"), new SessionCookie(9007199254740991, Buffer.from("ffe00000000000000000000000000000", "hex")));
    });
